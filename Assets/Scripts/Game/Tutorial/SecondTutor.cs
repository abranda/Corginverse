...
public class SecondTutor : MonoBehaviour {
	...
	void OnGUI(){
		...
		if (drawTutorial) {
			...
			if (drawIntro) {
				if (GUI.Button (new Rect (Screen.width / 4, Screen.height / 4, Screen.width / 2, Screen.height - (Screen.height / 4)), "Tutorial 2:\n\nGood job Corgi Master!\nCorgi loves its bone!\nNow drop your corgi to get another!\n\n\n(Tap here to continue)\n", customButton)) {
